      ...
      {eventData && (
        <>
          ...
          <div className="footer-bottom">
            <span className='p-2'>Powered by @tikio27</span>
            <a className='contact-us p-2' href="https://wa.me/523338454848?text=Hola%2C%20me%20gustaria%20recibir%20informes%20sobre%20la%20invitacion%20digital&lang=es" target="_blank">
              <img src={whatsappIcon} alt='contac-us' className="contact-us-whatsapp"/>
              <span className='px-2'>Informes al +52 3338454848</span>
            </a>
          </div>
          <div className='contac-us-fixed'>
            <a className='contact-us p-2' href="https://wa.me/523338454848?text=Hola%2C%20me%20gustaria%20recibir%20informes%20sobre%20la%20invitacion%20digital&lang=es" target="_blank">
              <img src={whatsappIcon} alt='contac-us' className="contact-us-whatsapp" />
            </a>
          </div>
